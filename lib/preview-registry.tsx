...
const PREVIEWS: Record<string, ComponentType> = {
  ...
  'additional-content': dynamic(() => import('@/components/AdditionalContent/AdditionalContent.preview'), { loading: Loading }),
  'additional-meta': dynamic(() => import('@/components/AdditionalMeta/AdditionalMeta.preview'), { loading: Loading }),
  ...
  bottom: dynamic(() => import('@/components/Bottom/Bottom.preview'), { loading: Loading }),
  ...
  cell: dynamic(() => import('@/components/Cell/Cell.preview'), { loading: Loading }),
  'cell-item': dynamic(() => import('@/components/CellItem/CellItem.preview'), { loading: Loading }),
  ...
  'info-card': dynamic(() => import('@/components/InfoCard/InfoCard.preview'), { loading: Loading }),
  ...
  pagination: dynamic(() => import('@/components/Pagination/Pagination.preview'), { loading: Loading }),
  ...
  sidebar: dynamic(() => import('@/components/Sidebar/Sidebar.preview'), { loading: Loading }),
  ...
  'text-rows': dynamic(() => import('@/components/TextRows/TextRows.preview'), { loading: Loading }),
  ...
  top: dynamic(() => import('@/components/Top/Top.preview'), { loading: Loading }),
  user: dynamic(() => import('@/components/User/User.preview'), { loading: Loading }),
}
